...
all: extractbitrate.js mp4check.js
...
mp4check.js: mp4check.cpp mp4v2/.libs/libmp4v2.a post.js
	...
	cat interface.js >>mp4check.js #add nicer interface, not using --post-js because of closure compiler
